...
mod tests {
    ...
    fn test_ts_generated_token_block_source_has_public_key_fact() {
        ...
        let biscuit_pubkey = public_key_to_biscuit(&root_public_key)
            .expect("should convert root key");
        ...
        let token_bytes = base64ct::Base64Url::decode_vec(token_b64)
            .expect("should decode base64url token");
        ...
        let block_source = biscuit.print_block_source(0)
